...
class RapidAPI {
    ...
    function __construct() {
        ...
        if ($_SESSION['livePayment'] == false) {
        	$this->APIConfig = parse_ini_file("sandbox/config.php");
		}
		else if ($_SESSION['livePayment'] == true) {
        	$this->APIConfig = parse_ini_file("live/config.php");
		}
    }
